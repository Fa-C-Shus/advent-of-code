...
import 'package:adventdart/src/command_runner.dart';
...
void main() {
  group('AdventdartCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late AdventdartCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = AdventdartCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = AdventdartCommandRunner();
