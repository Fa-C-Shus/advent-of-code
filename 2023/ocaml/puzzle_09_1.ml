  ...
  let rec predict_next_value parent_list child_list trail depth =
    ...
    | _ -> 
      ...
      | false ->
        ...
        predict_next_value child_list [] trail' (depth + 1)
      ;;
...
let rec analyze_oasis acc = 
  ...
  | Some line -> 
    ...
    let prediction = predict_next_value int_list [] [] 1 in
    (* let int_list = Helper.string_to_int_list line in
...
let () = 
  ...
  (*
  dune build puzzle_09_1.exe && cat ../data/day-09-test | dune exec ./puzzle_09_1.exe   
  *)
